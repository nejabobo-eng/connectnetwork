...
type AccountClientProps = { email?: string | null; firstName?: string | null; lastName?: string | null; fullName?: string | null; authError?: string }
...
export default function AccountClient({ email, firstName, lastName, fullName, authError }: AccountClientProps) {
  ...
  async function updateProfile(event: FormEvent<HTMLFormElement>) {
    event.preventDefault(); setMessage('Saving your details…')
    try {
